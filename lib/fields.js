...
Field.prototype.setup = function(name, model)
{
    ...
    this.name = name;
    this.model = model;
    this.backend = model.ns._backend;
...
Field.prototype.store = function(value, backend)
{
    // Validation might change value
    value = this.validate(value);

    backend  = backend || this.backend;

    var fieldType = this.constructor.name;
    backend.fields[fieldType].store(value);
}; // end store
...
PropertyField.prototype.store = function(value){};
...
RefListField.prototype.store = function(value)
{
    var fieldType = this.constructor.name;
    this.backend.fields['ListField'].store(value);
}; // end store
