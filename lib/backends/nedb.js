...
NEDBBackend.prototype.remove = function(modelInst, key, callback)
{
...
NEDBBackend.prototype.escapeFields = function(modelInst, prepared)
{
    _.each(modelInst.constructor.fields, function(field, name)
    {
        if(field.constructor.name == 'ListField')
        {
            if(field.opts.type && field.opts.type.constructor.name == 'ReferenceField')
            {
...
NEDBBackend.prototype.store = function(modelInst, prepared, callback)
{
    ...
    {
        db.insert(this.escapeFields(modelInst, prepared), function(error, doc)
        {
            if(error)
            {
                callback(error);
...
NEDBBackend.prototype.find = function(model, filter, callback)
{
    ...
    db.find(filter, function(error, found)
    {
        ...
        {
            doc['$id'] = doc['_id'];
            _.assing(doc, self.unescapeFields(model, doc));
            done();
        }, function(error)
        {
